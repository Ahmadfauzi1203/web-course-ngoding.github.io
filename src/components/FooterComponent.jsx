        ...
        <Row className="d-flex justify-content-between">
          <Col lg="5">
            ...
            <p className="desc">
              ...
              Cupiditate atque hic delectus, labore ipsum omnis aliquid id culpa
              blanditiis exercitationem?
            </p>
            <div className="no mb-1 mt-4">
              <Link className="text-decoration-none">
                <i className="fa-brands fa-whatsapp"></i>
                <p className="m-0">+62 8931-2133-423</p>
              </Link>
            </div>
            <div className="mail">
              <Link className="text-decoration-none">
        ...
        <Row>
          <Col>
            <p className="text-center px-md-0 px-3">
              ...
              <span className="fw-bold"> Ngoding Masteru</span>, All right
              Reserved.
            </p>
          </Col>
        </Row>
